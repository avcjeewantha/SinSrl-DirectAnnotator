...
def get_fasttext_vocab(vocab_words, filename):
    ...
    Args:
        vocab_words: set of words in the dataset
        filename: path to the fasttext vectors
    Returns:
        vocab: set() of strings
    """
    print("Building vocab...")
    vocab = set()
    fasttext_model = gensim.models.KeyedVectors.load(filename)
...
def export_trimmed_fasttext_vectors(vocab, fasttext_filename, trimmed_filename, dim):
    ...
    Args:
        ...
        fasttext_filename: a path to a fasttext file
